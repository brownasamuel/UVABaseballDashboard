...
ui <- fluidPage(
  ...
  navbarPage(
   ...
   navbarMenu(title = "Player Profiles",
              # Put in sub tabs
              tabPanel(title = "Connelly Early",
                       fluidRow(
                         column(2,
                                htmlOutput("pic"),
                                offset = 4))),
              tabPanel(title = "Kevin Jaxel",
                       fluidRow(
                         column(2,
                                imageOutput("pic2", width = "10%"),
                                offset = 4)))
              )
   )
  )
...
server = function(input, output) {
  ...
  output$pic <- renderText({
    c('<img src="', 
      "https://virginiasports.com/imgproxy/8bzkotY2slipAezVAVPqVJn8S4Xqrlo6vLJ6rxFN1jc/fit/600/800/ce/0/aHR0cHM6Ly9zdG9yYWdlLmdvb2dsZWFwaXMuY29tL3Zpcmdpbmlhc3BvcnRzLWNvbS8yMDIyLzEwL2QxMDliMGZhLWVhcmx5X2Nvbm5lbGx5XzIzbS1lMTY2NTc1NjM4Mzc2Ni5qcGc.jpg", 
      '">')
    })
  
  output$pic2 <- renderImage({
    tmpfile <- image_read("https://virginiasports.com/imgproxy/8bzkotY2slipAezVAVPqVJn8S4Xqrlo6vLJ6rxFN1jc/fit/600/800/ce/0/aHR0cHM6Ly9zdG9yYWdlLmdvb2dsZWFwaXMuY29tL3Zpcmdpbmlhc3BvcnRzLWNvbS8yMDIyLzEwL2QxMDliMGZhLWVhcmx5X2Nvbm5lbGx5XzIzbS1lMTY2NTc1NjM4Mzc2Ni5qcGc.jpg") %>%
...
# Tab ideas:
# Game summaries(Add filters for batter handedness, results of the pitch), player profiles(stats for season), pitcher comps, season long stats(velo and spin throughout year along with stats), thresholds(pitches above speed or above a certain location)
```
