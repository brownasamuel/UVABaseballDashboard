...
ui <- fluidPage(
  ...
  navbarPage(
    ...
    navbarMenu(title = "Pitcher Profiles",
               ...
               playerTab("Jake Berry"),
               playerTab("Evan Blanco"),
               playerTab("Matthew Buchanan"),
               playerTab("Connelly Early"),
               playerTab("Brian Edgington"),
               playerTab("Alex Greene"),
               playerTab("Bradley Hodges"),
               playerTab("Jake Hodorovich"),
               playerTab("Chase Hungate"),
               playerTab("Kevin Jaxel"),
               playerTab("Avery Mabe"),
               playerTab("Cullen McKay"),
               playerTab("Jack O'Connor"),
               playerTab("Nick Parker"),
               playerTab("Angelo Tonas"),
               playerTab("Jay Woolfolk")
               )
    )
  )
