...
# Tab ideas:
# Game summaries, pitcher comps, season long stats(velo and spin throughout year along with stats), thresholds(pitches above speed or above a certain location)
```
